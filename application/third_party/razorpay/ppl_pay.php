...
<?php
$name=$_REQUEST['payname'];
$amount=$_REQUEST['payamount'];
if($amount==""){
 header('location:https://www.emarketz.net/ppl-form.php');
}
//$amount=1;
$email=$_REQUEST['payemail'];
$mobile=$_REQUEST['paymobile'];
...
$data = [
	...
	"mobile"            => $mobile,
	"email"             => $email,
    "description"       => "Emarketz",
    "image"             => "https://www.emarketz.net/img/logo-new.png",
...
<form action="pplverify.php" method="POST" name="form1" id="form1">
  <script
