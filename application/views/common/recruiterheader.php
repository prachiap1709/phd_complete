      ...
      <div class="page">
         <div class="page-main">
            ...
            <div class="app-header header-search-icon">
			   ...
			   <div class="ml-auto pt-3"><img src="<?php echo $profileImg;?>" class="pr-img"><strong>Welcome <?php echo $userinfo->fld_name;?></strong></div>
            </div>
            ...
            <aside class="app-sidebar">
                     ...
                     <div class="dropdown user-pro-body text-center">
                        <a href="#" class="user-box">
						   ...
						   <img src="<?php echo $profileImg;?>" class="img-fluid pro-img mb-3">
                              <h5 class=" mb-1 font-weight-bold text-dark"><i class="fa fa-building"></i> <?php echo $userinfo->fld_name;?></h5>
                              <span class="text-muted app-sidebar__user-name text-sm">PhD Recruiter</span>
                           </div>
                        </a>
                     </div>
                  </div>
               ...
               <ul class="side-menu">
			      <li>
                     <a class="side-menu__item" href="<?php echo base_url();?>recruiter"><span class="side-menu__label"><i class="side-menu__icon fa fa-dashboard"></i> Dashboard</span></a>
                  </li>
                  <li>
                     <a class="side-menu__item" href="<?php echo base_url()?>profile"><span class="side-menu__label"><i class="side-menu__icon fa fa-pencil"></i> Profile</span></a>
                  </li>
				  
				  <li>
                     <a class="side-menu__item" href="<?php echo base_url();?>posted-job"><span class="side-menu__label"><i class="side-menu__icon fa fa-lock"></i> Posted Jobs</span></a>
                  </li>
				    <li>
                     <a class="side-menu__item" href="<?php echo base_url();?>add-new-job"><span class="side-menu__label"><i class="side-menu__icon fa fa-briefcase"></i> Add New Job</span></a>
                  </li>
				   <li>
