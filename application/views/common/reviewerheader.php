      ...
      <div class="page">
         <div class="page-main">
            ...
            <aside class="app-sidebar">
               ...
               <ul class="side-menu">
			      <li>
                     <a class="side-menu__item" href="<?php echo base_url();?>reviewer"><span class="side-menu__label"><i class="side-menu__icon fa fa-dashboard"></i> Dashboard</span></a>
                  </li>
                  <li>
				  ...
				  <li>
                     <a class="side-menu__item" href="<?php echo base_url();?>user-contacted"><span class="side-menu__label"><i class="side-menu__icon fa fa-lock"></i> User Contacted</span></a>
                  </li>
