         ...
         <div class="page-main">
            ...
            <div class="app-header header-search-icon">
               <div class="header-style1">
                  <a class="header-brand" href="<?php echo base_url();?>guide">
            ...
            <aside class="app-sidebar">
                     ...
                     <div class="dropdown user-pro-body text-center">
                        <a href="#" class="user-box">
						   ...
						   <img src="<?php echo $profileImg;?>" class="img-fluid pro-img mb-3">
                              ...
                              <span class="text-muted app-sidebar__user-name text-sm">PhD Guide</span>
                           </div>
                        </a>
                     </div>
                  </div>
               ...
               <ul class="side-menu">
			      <li>
                     <a class="side-menu__item" href="<?php echo base_url();?>guide"><span class="side-menu__label"><i class="side-menu__icon fa fa-dashboard"></i> Dashboard</span></a>
                  </li>
                  <li>
				  ...
				  <li>
                     <a class="side-menu__item" href="<?php echo base_url()?>user-contacted"><span class="side-menu__label"><i class="side-menu__icon fa fa-lock"></i> My Guide List</span></a>
                  </li>
