  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pt-3" id="forgetloader"> </div>
		</div>
		<form onsubmit="return forgetpassword('<?php echo base_url();?>');">
		<input type="text" name="usremail" id="usremail" class="form-control input_user" value="" placeholder="Email">
		</br>
		</br>
...
<div class="main-div">
   ...
   <form action="" method="post" onsubmit="return loginuser('<?php echo base_url();?>','')" id="loginfrm">
