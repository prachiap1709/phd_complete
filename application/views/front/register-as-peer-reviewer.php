<main>
    ...
    background-color: #f6f8fb7a;">
            <div class="container pb-5" >
			  ...
			  <div class="col-sm-3">
			    ...
			    <div class="col-sm-7">
						...
						<h3 class="border-bottom pb-3"> Register as Peer Reviewer</h3>
						
						<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
				
				<div class="row mt-45">
					<div class="col-sm-12 text-center pb-0 border-bottom mb-4">
						<h3>Process of Become a Peer Reviewer</h3>
					</div>
					<div class="col-sm-4">
					<div class="card p-3 text-left">
					<img src="assets/img/reg1.png" class="w-50">
						<h4 class="pt-3">Register Your Peer Review Details</h4>
					</div></div>
					...
					<img src="assets/img/ben.png" class="w-50">
						<h4 class="pt-3">Benefits of Peer Reviewer</h4>
					</div></div>
					
					<div class="col-sm-4 mb-3">
					<div class="card p-3 text-left">
					<img src="assets/img/faq.png" class="w-50">
						<h4 class="pt-3">FAQ of <br/> Peer Reviewer</h4>
					</div></div>
					<br/>
					<a onclick="scrollOnBox('#register')" class="edu-btn mt-5 mr-3 col-sm-3 mx-auto" style="cursor:pointer;" class="edu-btn mt-5 mr-3 col-sm-3 mx-auto">Register Now <i class="fa fa-angle-double-down"></i></a>
	  ...
	  <div class="col-sm-8">
		<h3 class="border-bottom pb-2">Benefits of Peer Reviewers</h3>
		<ul class="point">
...
<h4 class="border-bottom pb-2 mt-3">FAQ's Related to Become a Peer Reviewer</h4>
 <div id="accordion">
    <div class="card mb-3">
    ...
    <div class="card mb-3">
	  ...
	  <div class="col-sm-4" id="register">
			...
			<form class="register-form" id="registerForm" method="post" onsubmit="return registration('<?php echo base_url();?>');">
					<div class="col-sm-12">
						<div class="row">
						<h5 class="border-bottom pb-2">Register Your Account For Become Peer Reviewer</h5>
							<div class="col-sm-12 form-group">
								<input type="hidden" name="user_type" id="user_type" value="REVIEWER" />
