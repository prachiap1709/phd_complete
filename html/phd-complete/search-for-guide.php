            ...
            <div class="container pb-5" >
			   ...
			   <div class="col-sm-3">
			    ...
			    <div class="col-sm-7">
						...
						<h3 class="border-bottom pb-3">Search For Guide</h3>
...
<a href="#browse-review" class="btn btn-primary">Search Guide <i class="fa fa-angle-double-right ar-right text-light"></i></a>
<a href="register-as-a-guide.php" class="edu-btn mt-5">Register as Guide <i class="fa fa-angle-double-right ar-right text-light"></i></a>
					</div></div>
					<div class="col-sm-5"><img src="assets/img/search-guide.png" class="img-fluid"></div>
				</div>
	  ...
	  <div class="container">
	  <div class="row">
	  <div class="col-sm-12 text-left mb-4"><h4 class="border-bottom pb-3">Our Guide List</h4></div>
