                              ...
                              <div class="row">
                                 <div class="col-sm-3">
                                    <div class="form-group">
                                       <label for="exampleInputname"><strong>Enter Company Name</strong></label>
 ...
 <div class="col-sm-3">
        ...
        <select class="form-control">
		 ...
		 <div class="col-sm-3 mb-3">
            <label><strong>Enter Job Profile</strong></label>
            <input type="text" class="form-control" placeholder="Enter Job Profile">
        </div>
		
		<div class="col-sm-3 mb-3">
            <label><strong>Enter Experience</strong></label>
