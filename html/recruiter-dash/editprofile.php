                           ...
                           <div class="card-body p-0">
                              <div class="wideget-user text-center">
                                 <div class="wideget-user-desc pt-5">
                                    ...
                                    <div class="user-wrap">
                                       <h5 class="pro-user-username text-dark"><i class="fa fa-building"></i> ABCD Company Pvt. Ltd.</h5>
                                       <h6 class="text-muted mb-2"><i class="fa fa-users"></i> 40 Employees</h6>
...
<div class="col-sm-6 form-group mt-3">
		...
		<div class="col-sm-6 form-group mt-3">
            <label><strong>Enter Employee Strength</strong></label>
            <input type="text" class="form-control" placeholder="Enter Employee Strength">
        </div>
                              <div class="col-md-12">
